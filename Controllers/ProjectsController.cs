...
namespace ShadowTracker.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyId,Name,Description,StartDate,EndDate,ImageFileName,ImageFileData,ImageContentType,Archived,ProjectPriorityId")] Project project)
        {
